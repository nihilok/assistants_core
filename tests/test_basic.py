"""Basic tests for assistants_core package."""

import pytest
from assistants_core import UniversalLLMClient, ProviderType
from assistants_core.models import ModelCapabilities, MessageRole, Message
from assistants_core.exceptions import ModelNotSupportedError
