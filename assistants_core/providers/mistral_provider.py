...
import httpx
from ..models import CompletionRequest, CompletionResponse, ModelCapabilities, ProviderType
...
class MistralProvider(BaseLLMProvider):
    ...
    def supported_models(self) -> List[str]:
        """Return list of supported Mistral models."""
        return [
            "mistral-tiny",
            "mistral-small",
            "mistral-medium",
    ...
    def get_model_capabilities(self, model: str) -> ModelCapabilities:
        ...
        if not self.validate_model(model):
            raise ModelNotSupportedError(f"Model {model} is not supported by Mistral provider")
    ...
    async def complete(self, request: CompletionRequest) -> CompletionResponse:
        ...
        if not self.validate_model(request.model):
            raise ModelNotSupportedError(f"Model {request.model} is not supported by Mistral provider")
